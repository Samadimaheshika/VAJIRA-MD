...
global.owner = process.env.OWNER_NUMBER  || '940711706701' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=yEVhwQLL#hBhQYDklyrULgwefgyE6XDDNlmHFPC7AKBI7jfQXaf8' ,
